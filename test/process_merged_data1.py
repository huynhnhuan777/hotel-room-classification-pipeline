...
def main():
    ...
    try:
        ...
        clean_and_save_to_db(df_b, map_b, 'Booking', 'clean_booking_test', engine)
    ...
    try:
        ...
        clean_and_save_to_db(df_i, map_i, 'Ivivu', 'clean_ivivu_test', engine)
    ...
    try:
        ...
        clean_and_save_to_db(df_m, map_m, 'Mytour', 'clean_mytour_test', engine)
